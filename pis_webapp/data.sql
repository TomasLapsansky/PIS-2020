...
INSERT INTO app_user (id, name, surname, email, password, role_id, address, city, code) values (2, 'Anton', 'Firc', 'xfirca00@stud.fit.vutbr.cz', 'passwd', 1, 'Ulica 123', 'Banska Bystrica', '97401');
